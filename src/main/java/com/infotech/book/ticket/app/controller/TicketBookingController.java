...
public class TicketBookingController {
	...
	public Ticket createTicket(@RequestBody Ticket ticket) {			//@RequestBody- it will convert the json from the request to java object
		return ticketBookingService.createTicket(ticket);
	}
	
	@GetMapping(value="/ticket/{ticketId}")
	public Optional<Ticket> getTicketById(@PathVariable("ticketId") Integer ticketId) {
		return ticketBookingService.getTicketById(ticketId);			//@Pathvariable will get the data from the uri and set to the argument
	}
	...
	/*
	 * @PutMapping(value="ticket/{ticketId}/{newEmail:.+}") public Ticket
